...
//          TODO (3) Create an Intent with the proper URI to start the DetailActivity
            //COMPLETE
            Intent detailIntentOfToday = new Intent(context, DetailActivity.class);
            detailIntentOfToday.setData(todaysWeatherUri);

//          TODO (4) Use TaskStackBuilder to create the proper PendingIntent
            //COMPLETE
            TaskStackBuilder tsb = TaskStackBuilder.create(context);
            tsb.addNextIntentWithParentStack(detailIntentOfToday);
            PendingIntent resultPendingIntent = tsb.getPendingIntent(0,
